...
const Footer = () => {
  ...
  return (
    <footer className="w-full">
      {/* 顶部分割线 */}
      <div className="flex flex-row items-center w-full text-center align-center">
        <div className="flex w-full border-t border-gray-200 border-solid dark:border-gray-800"></div>
        <div className="flex mx-3 font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
      ...
      <div className="flex justify-between items-center px-4 md:px-8 lg:px-32 py-3 max-sm:flex-col -mt-2.5">
        ...
        {/* 社交图标 */}
        <div className="flex items-center max-sm:order-first">
          {/* 网站统计 */}
